// API route: POST /api/projects/[id]/studies/[studyId]/tasks/[taskId]/compliance/[flagId]/dismiss
 ...
 * Dismiss a compliance flag (Manager only)
 */
export async function POST(
  ...
  try {
    ...
    const flag = await complianceService.dismissComplianceFlag(flagId, { notes }, user);
