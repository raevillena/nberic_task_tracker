...
export default function AnalyticsSummaryCards({ analytics }: AnalyticsSummaryCardsProps) {
  ...
  const adminTaskTotal = analytics.adminTaskMetrics?.total || 0;
  const adminTaskCompleted = analytics.adminTaskMetrics?.completed || 0;
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
      <div className="bg-white rounded-lg shadow-md p-3 sm:p-4">
        <div className="flex items-center justify-between">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1 sm:mt-2">{totalProjects}</p>
          </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-3 sm:p-4">
        <div className="flex items-center justify-between">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1 sm:mt-2">{totalTasks}</p>
            <p className="text-xs text-gray-500 mt-1 line-clamp-2">
              {completedTasks} completed
              {adminTaskTotal > 0 && ` • ${adminTaskTotal} admin`}
            </p>
          </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-3 sm:p-4">
        <div className="flex items-center justify-between">
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1 sm:mt-2">{activeTasks}</p>
      ...
      <div className="bg-white rounded-lg shadow-md p-3 sm:p-4">
        <div className="flex items-center justify-between">
          <div className="flex-1 min-w-0">
            <p className="text-xs sm:text-sm font-medium text-gray-600">Avg Completion Rate</p>
            <p className="text-xl sm:text-2xl font-bold text-gray-900 mt-1 sm:mt-2">{avgCompletionRate.toFixed(1)}%</p>
            {avgOnTimeRate > 0 && (
